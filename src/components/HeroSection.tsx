      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-20 lg:px-8">
        <div className="max-w-2xl space-y-4 sm:space-y-8">
          ...
          <div className="flex flex-col space-y-3">
            <a
              href="#"
              className="w-full sm:w-fit rounded-md bg-white px-6 sm:px-8 py-3 text-sm sm:text-base font-semibold text-green-600 transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-600"
            >
